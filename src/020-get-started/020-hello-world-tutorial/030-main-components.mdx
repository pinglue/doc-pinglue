...
Controller overview
---------------------
Controller is the building block a Pinglue app. In fact, you can imagine a Pinglue app as a collection of controllers that are all connected to a single component called *hub*. 
...
Now we want to export our controller from this module. so create th file `./lib/route1/index.js` and copy/paste the minimal controller template with some console.log added to the life cycle methods:
...
<Warn>
    Don't forget the *pg.yaml* file for these two new packages!
<Warn>
